...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator: AbstractValidator<Writer>
    {
        ...
        {
            RuleFor(x => x.WriterName).NotEmpty().WithMessage("Yazar adı-soyadı kısmı boş olamaz");
            ...
            RuleFor(x => x.WriterName).MaximumLength(50).WithMessage("En fazla 50 karakter veri girişi yapılabilir");
        }
    }
}
